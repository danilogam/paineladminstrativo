	                    	...
	                    	<form action="{{route('posts.store')}}" method="POST" enctype="multipart/form-data">
	                    		...
	                    		<div class="form-group row">
                                    <div class="col-md-6">  <!-- <status> do post -->
                                        ...
                                        <select name="status" class="form-control">
                                            <option value="1" @if(old('status')==0) selected @endif>Publicado</option>
                                            <option value="0" @if(old('status')==0) selected @endif>Rascunho</option>
                                        </select>
                                    </div>
                                    ...
                                    <div class="col-md-6">  <!-- <categoria_id> do post -->
                                        ...
                                        <select name="categoria_id" class="form-control">
                                            ...
                                            <option value="{{$categoria->id}}" @if(old('categoria_id')==$categoria->id) selected @endif>{{$categoria->label}}</option>
                                            @endforeach 
                                        </select>
                                    </div>
                                </div>
                                        ...
                                        <select name="gallery_id" class="form-control">
                                            ...
                                            @if(!empty($galerias))
                                                @foreach($galerias as $galeria)
                                                    <option value="{{$galeria->id}}" @if(old('gallery_id')==$galeria->id) selected @endif>{{$galeria->name}}</option>
                                                @endforeach
                                            @endif
                                        </select>
                                    </div>
                                ...
                                <div class="form-group row">
                                    <div class="col-md-12"> <!-- <summary> do post -->
                                        ...
                                        <textarea class="form-control editor_texto" rows="5" name="summary">{{old('summary')}}</textarea>
                                    </div>
                                </div>
                                ...
                                <div class="form-group row">
                                    <div class="col-md-12"> <!-- <content> do post -->
                                        ...
                                        <textarea class="editor_texto" name="content">{{old('content')}}</textarea>
                                    </div>
                                </div>
