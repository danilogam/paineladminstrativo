            ...
            <div class="card">
                <div class="card-body card-login">
                    ...
                    <h3 class="text-center m-0">
                        <a href="{{route('login')}}" class="logo logo-admin"><img src="{{asset('assets/cms/images/logo_horizontal.png')}}" alt="logo"></a>
                    </h3>

                    <div class="p-3">
                        <h4 class="text-muted font-18 mb-3 text-center">Insira seu e-mail para recuperação!</h4>
